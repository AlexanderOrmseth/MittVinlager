...
const Paginator = ({ status, top }: Props) => {
  ...
  return (
    <div className="flex items-center border rounded bg-white shadow-xxs">
      {top && <ViewModeToggle />}
      <div
        className={` ${
          top ? "" : ""
        } flex flex-1 md:py-1.5 py-1 px-4 items-center text-sm gap-4 flex-row text-gray-900 font-medium justify-between 
   `}
      >
