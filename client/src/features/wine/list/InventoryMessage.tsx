...
const InventoryMessage: FunctionComponent<Props> = ({
  ...
  return (
    <div className="flex py-12 text-muted items-center justify-center flex-col gap-y-2">
      ...
      <motion.div
        className="mb-4 relative text-gray-200 bg-gray-700 p-2 rounded"
      ...
      >
        {message}
        <div className="absolute top-0 left-1/2 w-0 h-0 border-[16px] border-transparent -mt-3.5 ml-4 border-t-0 border-l-0 border-b-gray-700" />
      </motion.div>
      {children}
    </div>
  );
